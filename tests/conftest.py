...
def sample_transactions():
    ...
    data = {
        ...
        "Дата платежа": [
            "02.12.2023", "16.01.2024", "02.02.2024",
            "16.02.2024", "02.03.2024", "16.03.2024",
            "02.04.2024", "16.04.2024"
        ],
        "Номер карты": [
            "1234**5678", "12345678", "8765**4321",
            "1234**5678", "87654321", "1234**5678",
            "8765**4321", "1234**5678"
        ],
        "Статус": ["OK"] * 8,
        ...
        "Категория": ["Супермаркеты", "Рестораны", "Супермаркеты", "Рестораны",
                      "Супермаркеты", "Рестораны", "Супермаркеты", "Рестораны"],
        "Описание": ["Покупка в магазине", "Обед в ресторане", "Покупка продуктов",
                     "Ужин в кафе", "Супермаркет", "Кофейня", "Магазин", "Ресторан"],
...
def transactions_mixed_amounts():
    ...
    data = {
        "Дата операции": ["01.01.2024 12:00:00", "02.01.2024 14:00:00", "03.01.2024 10:00:00"],
        "Дата платежа": ["02.01.2024", "03.01.2024", "04.01.2024"],
        "Номер карты": ["1234****5678"] * 3, "Статус": ["OK"] * 3,
